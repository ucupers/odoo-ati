...
#         print("select ile.item_no, round(abs(sum(ile.quantity))::numeric,2) as total from sis_ile_odoo_bk ile "+\
...
#                         xbg = "ile.bisnis_group='ATI"+filter.factory_code+"' "
                        xwer="ile.bisnis_group='ATI"+filter.factory_code+"' "
                    else:
#                         xbg = " and ile.bisnis_group='ATI"+filter.factory_code+"' "
                        xwer += " and ile.bisnis_group='ATI"+filter.factory_code+"' "
...
#                         xwer_ibk = "(it.buku_kuning=1 and it.exclude_bc=1)"
                        xwer = "(it.buku_kuning=0 and it.exclude_bc=1)"
                        xwer2 = "(it.buku_kuning=1 and it.exclude_bc=1)"
                    else:
...
#                         xwer_ibk = " and (it.buku_kuning=1 and it.exclude_bc=1)"
                        xwer += " and (it.buku_kuning=0 and it.exclude_bc=1)"
                        xwer2+= " and (it.buku_kuning=1 and it.exclude_bc=1)"
...
#             self._insert_decrease_bk("ile.posting_date between '"+xTanggal1+"' and '"+xTanggal2+"'"+xWhere+xwer_ibk)
            ...
            self._insert_begbal("ile.posting_date<'"+xTanggal1+"'"+xWhere)
            self._insert_increase("ile.posting_date between '"+xTanggal1+"' and '"+xTanggal2+"'"+xWhere)
            self._insert_decrease("ile.posting_date between '"+xTanggal1+"' and '"+xTanggal2+"'"+xWhere)

            self._insert_begbal_bk("ile.posting_date<'"+xTanggal1+"'"+xWhere2)
            self._insert_increase_bk("ile.posting_date between '"+xTanggal1+"' and '"+xTanggal2+"'"+xWhere2)
            self._insert_decrease_bk("ile.posting_date between '"+xTanggal1+"' and '"+xTanggal2+"'"+xWhere2)
...
#         print(xLokasi)
        workbook = xlsxwriter.Workbook('/home/rusdi/Documents/shared/'+xLaporan)        
...
#        versi 1 dan 2
        worksheet.insert_image('A1', '/home/rusdi/Documents/shared/logo-aja.png')
        if xLokasi=="1":
...
#            versi 2
        ...
        for r in rec:
            vals={ 
                    'rpt_xlsx':base64.b64encode(open("/home/rusdi/Documents/shared/"+xLaporan, "rb").read())
